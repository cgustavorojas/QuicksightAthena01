...
- [10 min - Breakout Exercises](#breakout-exercises)</br>
...
- Unzip the data, and upload it to your S3 Bucket **remember, one folder represents one table.** USE upload_to_s3.sh on script folder
